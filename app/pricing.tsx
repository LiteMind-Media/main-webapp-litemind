...
const Pricing = () => {
    ...
    return (
        <div className="text-white my-24 relative py-10" id="pricing" style={{ zIndex: 1 }}>
            ...
            <AnimatedElement direction="up" className="p-4 mx-auto relative z-1 w-full pt-10 md:pt-20 px-2">
            ...
            <div className="container mx-auto px-4 relative z-1">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                    {/* Starter Plan */}
                    <AnimatedElement direction="up" delay={0.2} className="relative">
                        <div className="bg-gradient-to-b from-black/60 to-amber-950/30 rounded-2xl p-1">
                    ...
                    <AnimatedElement direction="up" delay={0.3} className="relative">
                        <div className="bg-gradient-to-b from-amber-400/30 to-amber-600/20 rounded-2xl p-1.5 transform md:-translate-y-4 scale-105">
                    ...
                    {/* Pro Plan */}
                    <AnimatedElement direction="up" delay={0.4} className="relative">
                        <div className="bg-gradient-to-b from-black/60 to-amber-950/30 rounded-2xl p-1">
                            <div className="absolute inset-0 bg-gradient-to-b from-amber-500/20 to-transparent opacity-30 rounded-2xl"></div>
                            <div className="bg-black/80 rounded-2xl p-8 h-full flex flex-col relative z-1">
                ...
                <AnimatedElement direction="up" delay={0.5} className="mt-16 text-center">
