...
const Pricing = () => {
    return (
        <div className="text-white my-24 relative py-10" id="pricing">
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                    ...
                    <div className="relative bg-gradient-to-b from-black/60 to-amber-950/30 rounded-2xl p-1">
                        ...
                        <div className="bg-black/80 rounded-2xl p-8 h-full flex flex-col relative z-10">
                            ...
                            <button className="w-full py-3 px-4 bg-amber-600 hover:bg-amber-700 text-white rounded-lg font-medium transition-colors duration-300">
                                Get Started
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="relative bg-gradient-to-b from-amber-400/30 to-amber-600/20 rounded-2xl p-1.5 transform md:-translate-y-4 scale-105">
                        ...
                        <div className="bg-black/80 rounded-2xl p-8 h-full flex flex-col relative z-10">
                            ...
                            <button className="w-full py-3 px-4 bg-gradient-to-r from-amber-400 to-amber-600 hover:from-amber-500 hover:to-amber-700 text-black font-semibold rounded-lg transition-colors duration-300">
                                Get Started
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="relative bg-gradient-to-b from-black/60 to-amber-950/30 rounded-2xl p-1">
                        ...
                        <div className="bg-black/80 rounded-2xl p-8 h-full flex flex-col relative z-10">
                            ...
                            <button className="w-full py-3 px-4 bg-transparent border border-amber-500 hover:bg-amber-900/30 text-amber-400 rounded-lg font-medium transition-colors duration-300">
                                Contact Us
                            </button>
                        </div>
                    </div>
                ...
                <div className="mt-16 text-center">
                    ...
                    <button className="px-8 py-3 bg-white/10 hover:bg-white/20 transition-colors duration-300 rounded-lg text-white font-medium border border-white/20">
