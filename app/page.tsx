  ...
  return (
    <div className="w-full min-h-screen md:items-center md:justify-center bg-black/[0.96] antialiased bg-grid-white[0.02] relative overflow-x-hidden">
      ...
      <div className="p-4 mx-auto relative z-10 w-full pt-10 md:pt-20 px-2">
        ...
        <Link href="/about" className="cursor-pointer flex items-center justify-center border border-orange-500/20 hover:border-orange-500/40 rounded-full w-48 p-2 mx-auto my-6 text-white hover:bg-orange-500/10 transition-all duration-300">
          Get Started!
        </Link>
        ...
        <div className="w-full pt-20">
          ...
          {/* Background gradient that flows throughout */}
