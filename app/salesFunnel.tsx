...
const SalesFunnel = () => {
    return (
        <div id="sales-funnel" className="text-white my-24 relative">
            ...
            <div className="container mx-auto px-4 py-12 relative z-10">
                <div className="flex flex-col md:flex-row justify-center items-center space-y-8 md:space-y-0 md:space-x-6">
                    <AnimatedElement direction="left" delay={0.3} className="w-full md:w-1/2">
                        <Image
            ...
            <AnimatedElement delay={0.8} className="mt-12 container mx-auto px-4 relative z-10">
