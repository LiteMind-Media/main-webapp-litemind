        ...
        <div id="paid-ads" className="text-white my-24 relative pb-12">
            ...
            <div className="container mx-auto px-4 relative z-10 mb-16">
                <div className="flex flex-col lg:flex-row items-center gap-16">
                    ...
                    <AnimatedElement direction="right" delay={0.3} className="lg:w-1/2 order-1 lg:order-2">
            ...
            <AnimatedElement delay={0.6} className="mt-12 container mx-auto px-4 relative z-10">
